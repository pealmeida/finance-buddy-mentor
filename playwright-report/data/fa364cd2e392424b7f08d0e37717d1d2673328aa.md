...
- Name: Progress Indicator Component >> highlights the current step with blue background and bold text
- Location: C:\Users\pealm\Code\finance-buddy-mentor\tests\onboarding\StepIndicator.spec.ts:25:5
...
Call log:
  ...
  - waiting for locator('[aria-current="step"]')
    ...
    at C:\Users\pealm\Code\finance-buddy-mentor\tests\onboarding\StepIndicator.spec.ts:29:44
```
