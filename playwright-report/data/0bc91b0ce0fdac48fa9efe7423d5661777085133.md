...
- Name: Progress Indicator Component >> displays green checkmark for completed steps
- Location: C:\Users\pealm\Code\finance-buddy-mentor\tests\onboarding\StepIndicator.spec.ts:34:5
...
Call log:
  - waiting for getByRole('button', { name: 'Next' })
    ...
    at C:\Users\pealm\Code\finance-buddy-mentor\tests\onboarding\StepIndicator.spec.ts:35:58
```
