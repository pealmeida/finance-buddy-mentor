...
import { FinancialGoal, Investment, RiskProfile, UserProfile } from '@/types/finance';
...
interface OnboardingContextType {
  ...
  updateCurrentInvestment: (updates: Partial<typeof initialCurrentInvestment>) => void;
  addInvestment: () => void;
...
export const OnboardingProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [currentInvestment, setCurrentInvestment] = useState(initialCurrentInvestment);
  ...
  const updateCurrentInvestment = (updates: Partial<typeof initialCurrentInvestment>) => {
